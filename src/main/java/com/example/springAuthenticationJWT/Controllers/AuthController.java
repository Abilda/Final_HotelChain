...
import com.example.springAuthenticationJWT.payload.request.LoginRequest;
import com.example.springAuthenticationJWT.payload.request.SignupRequest;
...
import com.example.springAuthenticationJWT.repository.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        try {
            ...
            System.out.println("I know how to deal with it.");
            return ResponseEntity.ok(new JwtResponse(null,null, null,null,null,false));
        }
    }
